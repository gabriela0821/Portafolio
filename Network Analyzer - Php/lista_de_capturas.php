...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <p class="text">
                Se muestra la lista de capturas tomadas por el usuario.
            </p>
            ...
            <body>
                <table>
                    ...
                    $sql="SELECT idcaptura, tipo_serv 
                    FROM captura c, usuario usu
                    ...
                    ?> 
                    <tr>
                        <td><?php echo $mostrar['idcaptura']; ?></td>
                        <td><?php echo $mostrar['tipo_serv']; ?></td>
                    </tr>
                <?php
                    }
                    ?>
